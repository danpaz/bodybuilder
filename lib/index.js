...
var BodyBuilder = (function () {
  ...
  _createClass(BodyBuilder, [{
    ...
    value: function filter(type) {
      ...
      currentFilter = _lodash2['default'].get(body, 'query.filtered.filter');
      _lodash2['default'].set(body, 'query.filtered.filter', (0, _utils.boolMerge)('filter', newFilter, currentFilter, 'and'));
      return this;
    }
  }, {
    key: 'orFilter',
    value: function orFilter(type) {
      ...
      newFilter = klass.apply(undefined, args);
      currentFilter = _lodash2['default'].get(body, 'query.filtered.filter');
      _lodash2['default'].set(body, 'query.filtered.filter', (0, _utils.boolMerge)('filter', newFilter, currentFilter, 'or'));
      return this;
    }
  }, {
    key: 'notFilter',
    value: function notFilter(type) {
      ...
      newFilter = klass.apply(undefined, args);
      currentFilter = _lodash2['default'].get(body, 'query.filtered.filter');
      _lodash2['default'].set(body, 'query.filtered.filter', (0, _utils.boolMerge)('filter', newFilter, currentFilter, 'not'));
      return this;
    }
    ...
    value: function aggregation(type) {
      ...
      _lodash2['default'].set(body, 'aggregations', _lodash2['default'].merge({}, this._body.aggregations, aggregation));
      return this;
    }
    ...
    value: function query(type) {
      ...
      currentQuery = _lodash2['default'].get(body, 'query.filtered.query');
      _lodash2['default'].set(body, 'query.filtered.query', (0, _utils.boolMerge)('query', newQuery, currentQuery, 'and'));
      return this;
    }
  }, {
    key: 'andQuery',
    value: function andQuery(type) {
      var klass = _queries2['default'][type];
      var body = this._body;
      var newQuery = undefined;
      var currentQuery = undefined;
    ...
    value: function orQuery(type) {
      ...
      newQuery = klass.apply(undefined, args);
      currentQuery = _lodash2['default'].get(body, 'query.filtered.query');
      _lodash2['default'].set(body, 'query.filtered.query', (0, _utils.boolMerge)('query', newQuery, currentQuery, 'or'));
      return this;
    }
  }, {
    key: 'notQuery',
    value: function notQuery(type) {
      ...
      newQuery = klass.apply(undefined, args);
      currentQuery = _lodash2['default'].get(body, 'query.filtered.query');
      _lodash2['default'].set(body, 'query.filtered.query', (0, _utils.boolMerge)('query', newQuery, currentQuery, 'not'));
      return this;
    }
