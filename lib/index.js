...
var BodyBuilder = (function () {
  ...
  _createClass(BodyBuilder, [{
    ...
    value: function build() {
      var body = _lodash2['default'].clone(this._body);
      var filters = this._filters;
      var queries = this._queries;
      var aggregations = this._aggreggations;

      if (!_lodash2['default'].isEmpty(filters)) {
        _lodash2['default'].set(body, 'query.filtered.filter', filters);

        if (!_lodash2['default'].isEmpty(queries)) {
          _lodash2['default'].set(body, 'query.filtered.query', queries);
        }
      } else if (!_lodash2['default'].isEmpty(queries)) {
        _lodash2['default'].set(body, 'query', queries);
      }

      if (!_lodash2['default'].isEmpty(aggregations)) {
        _lodash2['default'].set(body, 'aggregations', aggregations);
      }
    ...
    value: function query() {
      ...
      this._query.apply(this, ['and'].concat(args));
      return this;
    }
    ...
    value: function aggregation(type) {
      ...
      this._aggreggations = _lodash2['default'].merge({}, this._aggreggations, aggregation);
      return this;
    }
