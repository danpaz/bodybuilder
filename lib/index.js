...
var BodyBuilder = (function () {
  ...
  _createClass(BodyBuilder, [{
    ...
    value: function filter(type) {
      ...
      _lodash2['default'].set(body, 'query.filtered.filter', (0, _utils.boolMerge)(newFilter, currentFilter, 'and'));
      return this;
    }
  }, {
    key: 'orFilter',
    value: function orFilter(type) {
      ...
      newFilter = klass.apply(undefined, args);
      currentFilter = _lodash2['default'].get(body, 'query.filtered.filter');
      _lodash2['default'].set(body, 'query.filtered.filter', (0, _utils.boolMerge)(newFilter, currentFilter, 'or'));
      return this;
    }
  }, {
    key: 'notFilter',
    value: function notFilter(type) {
      ...
      newFilter = klass.apply(undefined, args);
      currentFilter = _lodash2['default'].get(body, 'query.filtered.filter');
      _lodash2['default'].set(body, 'query.filtered.filter', (0, _utils.boolMerge)(newFilter, currentFilter, 'not'));
      return this;
    }
    ...
    value: function query(type) {
      ...
      _lodash2['default'].set(body, 'query.filtered.query', (0, _utils.boolMerge)(newQuery, currentQuery, 'and'));
      return this;
    }
  }, {
    key: 'andQuery',
    ...
    value: function orQuery(type) {
      ...
      newQuery = klass.apply(undefined, args);
      currentQuery = _lodash2['default'].get(body, 'query.filtered.query');
      _lodash2['default'].set(body, 'query.filtered.query', (0, _utils.boolMerge)(newQuery, currentQuery, 'or'));
      return this;
    }
  }, {
    key: 'notQuery',
    value: function notQuery(type) {
      ...
      newQuery = klass.apply(undefined, args);
      currentQuery = _lodash2['default'].get(body, 'query.filtered.query');
      _lodash2['default'].set(body, 'query.filtered.query', (0, _utils.boolMerge)(newQuery, currentQuery, 'not'));
      return this;
    }
