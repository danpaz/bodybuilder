...
var BodyBuilder = function () {
  ...
  _createClass(BodyBuilder, [{
    ...
    value: function _buildV1() {
      var body = (0, _clone3.default)(this._body);
      var filters = this._filters;
      var queries = this._queries;
      var aggregations = this._aggBuilder.aggregations;

      if (!(0, _isEmpty3.default)(filters)) {
        (0, _set3.default)(body, 'query.filtered.filter', filters);

        if (!(0, _isEmpty3.default)(queries)) {
          (0, _set3.default)(body, 'query.filtered.query', queries);
        }
      } else if (!(0, _isEmpty3.default)(queries)) {
        (0, _set3.default)(body, 'query', queries);
      }

      if (!(0, _isEmpty3.default)(aggregations)) {
        (0, _set3.default)(body, 'aggregations', aggregations);
      }
    ...
    value: function _buildV2() {
      ...
      if (!(0, _isEmpty3.default)(filters)) {
        ...
        (0, _merge3.default)(body, filterBody, queryBody);
      } else if (!(0, _isEmpty3.default)(queries)) {
        (0, _set3.default)(body, 'query', queries);
      }

      if (!(0, _isEmpty3.default)(aggregations)) {
        (0, _set3.default)(body, 'aggs', aggregations);
      }
    ...
    value: function sort(field) {
      ...
      if ((0, _isArray3.default)(field)) {
        ...
        if ((0, _isPlainObject3.default)(this._body.sort)) {
          this._body.sort = [this._body.sort];
        }

        if ((0, _isArray3.default)(this._body.sort)) {
