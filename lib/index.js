...
var _aggregationsMaxAggregation = require('./aggregations/max-aggregation');

var _aggregationsMaxAggregation2 = _interopRequireDefault(_aggregationsMaxAggregation);

var _aggregationsMinAggregation = require('./aggregations/min-aggregation');

var _aggregationsMinAggregation2 = _interopRequireDefault(_aggregationsMinAggregation);

var _queriesFuzzyQuery = require('./queries/fuzzy-query');

var _queriesFuzzyQuery2 = _interopRequireDefault(_queriesFuzzyQuery);

var _queriesMatchQuery = require('./queries/match-query');

var _queriesMatchQuery2 = _interopRequireDefault(_queriesMatchQuery);

var _queriesRangeQuery = require('./queries/range-query');

var _queriesRangeQuery2 = _interopRequireDefault(_queriesRangeQuery);

var _queriesTermQuery = require('./queries/term-query');

var _queriesTermQuery2 = _interopRequireDefault(_queriesTermQuery);

var _queriesTermsQuery = require('./queries/terms-query');

var _queriesTermsQuery2 = _interopRequireDefault(_queriesTermsQuery);
...
var AGGREGATIONS_MAP = {
  ...
  min: _aggregationsMinAggregation2['default'],
  max: _aggregationsMaxAggregation2['default']
};

var QUERIES_MAP = {
  fuzzy: _queriesFuzzyQuery2['default'],
  match: _queriesMatchQuery2['default'],
  range: _queriesRangeQuery2['default'],
  term: _queriesTermQuery2['default'],
  terms: _queriesTermsQuery2['default']
};
